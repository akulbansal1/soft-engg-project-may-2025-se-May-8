      ...
      <div className="relative z-10 max-w-2xl mx-auto space-y-12 lg:space-y-16">
        ...
        <div className="flex items-center justify-center space-x-8 lg:space-x-12">
          <div className="flex flex-col items-center space-y-2">
            <div className="w-12 h-12 lg:w-14 lg:h-14 rounded-2xl bg-gradient-to-br from-green-500/20 to-green-600/20 border border-green-500/30 flex items-center justify-center">
          ...
          <div className="flex flex-col items-center space-y-2">
            <div className="w-12 h-12 lg:w-14 lg:h-14 rounded-2xl bg-gradient-to-br from-blue-500/20 to-blue-600/20 border border-blue-500/30 flex items-center justify-center">
          ...
          <div className="flex flex-col items-center space-y-2">
            <div className="w-12 h-12 lg:w-14 lg:h-14 rounded-2xl bg-gradient-to-br from-purple-500/20 to-purple-600/20 border border-purple-500/30 flex items-center justify-center">
        ...
        <div className="space-y-4">
          <Link to="/authentication" className="block">
            <Button
              size="lg"
              className="w-full lg:w-80 mx-auto text-lg font-semibold py-4 rounded-2xl bg-gradient-to-r from-primary via-primary/95 to-primary/90 hover:from-primary/95 hover:via-primary/90 hover:to-primary/85 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] border border-primary/20"
            >
          ...
          <p className="text-xs text-muted-foreground/70">
            Join thousands who trust Svaasthy with their healthcare
          </p>
        </div>
      </div>
