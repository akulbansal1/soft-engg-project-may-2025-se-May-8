...
app = FastAPI(
    ...
    "|---|----------------------|--------------|\n"
    "| 1 | UI accessibility | (Frontend/UI, not API) |\n"
    "| 2 | Medicine management | `/medicines/`, `/medicines/{medicine_id}`, `/medicines/transcribe` |\n"
    "| 3 | Appointment management | `/appointments/`, `/appointments/user/{user_id}` |\n"
    "| 4 | Emergency contact notification | `/users/{user_id}/sos/trigger`, `/emergency-contacts/` |\n"
    "| 5 | Document storage | `/documents/`, `/documents/upload`, `/documents/user/{user_id}` |\n"
    "| 6 | Medication adherence tracking | `/medicines/`, `/medicines/user/{user_id}` |\n"
    "| 7 | Shared calendar | `/appointments/`, `/appointments/user/{user_id}` |\n"
    "| 8 | Emergency alerts | `/users/{user_id}/sos/trigger`, `/emergency-contacts/` |\n"
    "| 9 | Report sharing | `/documents/`, `/documents/user/{user_id}` |\n"
    "| 10 | App tutorials | (Frontend/UI, not API) |\n"
    "| 11 | Patient history review | `/users/{user_id}`, `/documents/user/{user_id}`, `/medicines/user/{user_id}`, `/appointments/user/{user_id}` |\n"
    "| 12 | System reliability | (Infra/DevOps, not API) |\n\n"
    "---\n\n"
    "## External APIs\n\n"
    ...
    "    - `/auth/sms/resend` (resend verification code)\n\n"
